...
VALUES ('veinAdmin', '$2a$10$PVtwAHL9HRydmZ3GLE1CpeN/pQrEf5K8wfowqW/X0iwJt8ZE.7LVe', 'ADMIN');
...
CREATE UNIQUE INDEX category_idx_code ON category (code);
...
CREATE UNIQUE INDEX book_idx_code ON book (code);
